<template>
  <div>
    <el-row>
      ...
      <el-col :span="2">
        <el-button icon="el-icon-search" round type="primary">
          搜索
        </el-button>
      </el-col>
    </el-row>
    <el-table :data="tableData" style="width: 100%;margin-top: 30px" stripe>
      <el-table-column prop="id" label="文章id" width="70"></el-table-column>
      <el-table-column
        prop="attribute"
        label="文章属性"
        width="100"
...
<script>
import Title from "../../../article/form/Title";
import AttributeChoice from "../../../article/form/AttributeChoice";
